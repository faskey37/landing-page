  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "#1e2a3a", padding: "48px 40px 40px" }}
      >
        <div
          style={{
            maxWidth: 1280,
        ...
        >
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              ...
              >
                <svg width="26" height="26" viewBox="0 0 466 511.98" xmlns="http://www.w3.org/2000/svg">
    ...
    <path fill="#4285F4" fillRule="nonzero" d="M1.39 41.86c-1.39,4.18 -1.39,9.77 -1.39,15.34l0 397.64c0,5.57 0,9.76 1.4,15.34l216.27 -214.86 -216.28 -213.46z"/>
                ...
                <span style={{ color: "#cdd5e0", fontSize: 12 }}>
                  Google Play
                </span>
              </a>
              <a
      ...
      <div
        ...
        style={{ background: "#1e2a3a", padding: "24px 16px" }}
      >
        {/* Brand - Mobile */}
    ...
    <path fill="#4285F4" fillRule="nonzero" d="M1.39 41.86c-1.39,4.18 -1.39,9.77 -1.39,15.34l0 397.64c0,5.57 0,9.76 1.4,15.34l216.27 -214.86 -216.28 -213.46z"/>
        ...
        {footerSections.map((section) => (
          <div
            key={section.title}
            style={{ marginBottom: 12, borderBottom: "1px solid #2d3f55" }}
          >
            <button
      ...
      <div style={{ background: "#141d2b", padding: "32px 20px 0" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
              ...
              >
                {[
                  ...
                  <div key={item.name}>
                    ...
                    <span style={{ color: "#6b7f99", fontSize: 12 }}>
                      {item.sub}
                    </span>
                  </div>
                ))}
          ...
          >
            <Link
              href="#"
              style={{ color: "#8899aa", fontSize: 12, textDecoration: "none" }}
            >
